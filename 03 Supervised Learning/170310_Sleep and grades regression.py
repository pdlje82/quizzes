...
def compute_regression(sleep,scores):
    ...
    normalized_sleep = []
    for e in sleep:
        normalized_sleep.append(e - avg_sleep)

    normalized_scores = []
    for e in scores:
        normalized_scores.append(e - avg_scores)
    ...
    x = 0
    for e in normalized_sleep:
        x = x + np.square(e)        # sum of squares

    y = 0
    i  = 0
    while i < len(normalized_sleep):
        y = y + normalized_sleep[i] * normalized_scores[i]
        i += 1
