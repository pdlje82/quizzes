...
def EvalNetwork(inputValues, Network):
    ...
    # YOUR CODE HERE
    p1 = Perceptron(Network[0][0], 0.)
    out_1 = p1.activate(inputValues)

    p2 = Perceptron(Network[0][1], 0.5)
    out_2 = p2.activate(inputValues)

    p3 = Perceptron(Network[0][2], 0.)
    out_3 = p3.activate(inputValues)

    out_123 = np.array([out_1,out_2,out_3])

    p4 = Perceptron(Network[1][0], 0.)
    OutputValue = p4.activate(out_123)
